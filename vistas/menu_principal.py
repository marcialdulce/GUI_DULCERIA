...
class MenuPrincipal(tk.Frame):
    def __init__(self, parent, controlador):
        ...
        btn_logout = tk.Button(encabezado, text="Cerrar Sesión", bg="#D9534F", fg=BLANCO, font=("Arial", 8, "bold"), activebackground="#C9302C", activeforeground=BLANCO, relief="flat", cursor="hand2", command=self.controlador.cerrar_sesion)
        ...
        for opcion in opciones:
            boton = tk.Button(menu, text=opcion, bg=ROSA_MENU, fg=BLANCO, activebackground=ROSA_MENU_ACTIVO, activeforeground=BLANCO, bd=0, relief="flat", font=("Arial", 9, "bold"), cursor="hand2", command=lambda op=opcion: self.mostrar_seccion(op))
    ...
    def mostrar_seccion(self, opcion):
        ...
        if opcion == "INICIO":
            ...
            tk.Label(self.contenido, text=f"Pantalla de {opcion}\n(Pendiente de modularizar)", font=("Arial", 22, "bold"), bg=FONDO, fg="#333333").pack(pady=150)