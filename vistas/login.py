...
class PantallaLogin(tk.Frame):
    def __init__(self, parent, controlador):
        ...
        tk.Button(self, text="Ingresar", command=self.enviar_datos, width=18, bg=ROSA_MENU, fg=BLANCO, activebackground=ROSA_MENU_ACTIVO, activeforeground=BLANCO, bd=0, font=("Arial", 10, "bold")).pack(pady=25)
