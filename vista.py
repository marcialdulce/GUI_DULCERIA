...
class PantallaPrincipal(tk.Frame):
    ...
    def construir_inventario(self):
        ...
        tk.Label(barra_filtros, text="BUSCAR", bg="#3A8D96", fg=BLANCO, font=("Arial", 9, "bold")).pack(side="left", padx=10)
        self.txt_buscar_inv = tk.Entry(barra_filtros, width=18)
        self.txt_buscar_inv.pack(side="left", padx=5)
        # Evento para buscar mientras escribes
        self.txt_buscar_inv.bind("<KeyRelease>", lambda e: self.aplicar_filtros_inventario())

        tk.Label(barra_filtros, text="MARCA", bg="#3A8D96", fg=BLANCO, font=("Arial", 9, "bold")).pack(side="left", padx=(15, 5))
        ...
        tk.Label(barra_filtros, text="CATEGORÍA", bg="#3A8D96", fg=BLANCO, font=("Arial", 9, "bold")).pack(side="left", padx=(15, 5))
